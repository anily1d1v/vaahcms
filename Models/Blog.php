...
class Blog extends Model
{
    ...
    public function article() {
        return $this->belongsToMany( Article::class,
            'hw_article_blogs', 'hw_blog_id', 'hw_article_id'
        )->withPivot('is_active',
            'created_by',
            'created_at',
            'updated_by',
    ...
    {
        $all_articles= Article::select('id')->get()->pluck('id')->toArray();
        $all_blogs = self::select('id')->get();
        if(!$all_blogs)
        {
            return false;
        }
        ...
        {
            $blog->article()->syncWithoutDetaching($all_articles);
        }
